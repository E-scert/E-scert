...
- Build modular, demo-ready applications with fallback logic for constrained environments  
- Integrate frontend and backend workflows (Java EE, JSP, REST APIs)  
...
- **Tools & Workflows:** Git, GitHub, NetBeans, SQLPLUS  

## Interests
- Scenario-driven coding challenges  
- Visual frameworks (ER diagrams, flowcharts) for rapid comprehension  
- Exploring AI-assisted feedback for academic projects
- Database management\developer 

## Featured Projects (3-Tier Applications)

### [WIL-Provider-Project] **in progress**
